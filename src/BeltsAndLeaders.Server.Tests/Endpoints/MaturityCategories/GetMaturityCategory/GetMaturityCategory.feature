...
Feature: Get Maturity Category
    ...
    Scenario: Get MaturityCategory - Request Successful
    ...
    Scenario: Get MaturityCategory - Request Failure - Invalid Id URL parameter

        Given a request path for the 'Get Maturity Category' endpoint with an invalid Id parameter
        When the GET request is made
        Then (400) Bad Request is returned

    Scenario: Get MaturityCategory - Request Failure - Maturity Category resource does not exist
